  ...
  return (
    <>
      {form &&
        ...
        loading.loadings[Lists.COMMENTS] !== undefined &&
        Object.keys(loading.errors).length === 0 && (
          <div dir="rtl">
            <div>
            ...
            >
              ...
              <div>
                <button
                  disabled={
                    !forms.formValidation[Forms.CREATE_NEW_COMMENT] || loading.loadings[Forms.CREATE_NEW_COMMENT]
                  }
                  type="submit"

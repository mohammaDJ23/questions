...
const QuestionBox: FC<QuestionBoxObj> = ({ head, body }) => {
  return (
    <div className="w-full mb-5 rounded-xl overflow-hidden border-solid border-2 border-gray-100 shadow-[0px_3px_8px_-1px_rgba(50,50,71,0.05),_0px_0px_1px_rgba(12,26,75,0.24)]">
